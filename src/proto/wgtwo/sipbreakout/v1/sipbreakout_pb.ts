...
// @generated from file wgtwo/sipbreakout/v1/sipbreakout.proto (package wgtwo.sipbreakout.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from enum wgtwo.sipbreakout.v1.StatusCode
 */
...
proto3.util.setEnumType(StatusCode, "wgtwo.sipbreakout.v1.StatusCode", [
...
/**
 * @generated from enum wgtwo.sipbreakout.v1.RouteType
 */
...
proto3.util.setEnumType(RouteType, "wgtwo.sipbreakout.v1.RouteType", [
...
/**
 * @generated from message wgtwo.sipbreakout.v1.UpsertRegistrationRequest
 */
export class UpsertRegistrationRequest extends Message<UpsertRegistrationRequest> {
  /**
   * @generated from field: wgtwo.sipbreakout.v1.Registration registration = 1;
   */
  ...
  static readonly typeName = "wgtwo.sipbreakout.v1.UpsertRegistrationRequest";
...
/**
 * @generated from message wgtwo.sipbreakout.v1.UpsertRegistrationResponse
 */
export class UpsertRegistrationResponse extends Message<UpsertRegistrationResponse> {
   ...
   *
   * @generated from field: wgtwo.sipbreakout.v1.StatusCode status_code = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "wgtwo.sipbreakout.v1.UpsertRegistrationResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message wgtwo.sipbreakout.v1.DeleteRegistrationRequest
 */
export class DeleteRegistrationRequest extends Message<DeleteRegistrationRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "wgtwo.sipbreakout.v1.DeleteRegistrationRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "registration", kind: "message", T: Registration },
  ]);
...
/**
 * @generated from message wgtwo.sipbreakout.v1.DeleteRegistrationResponse
 */
export class DeleteRegistrationResponse extends Message<DeleteRegistrationResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "wgtwo.sipbreakout.v1.DeleteRegistrationResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "status_code", kind: "enum", T: proto3.getEnumType(StatusCode) },
    { no: 2, name: "error_message", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message wgtwo.sipbreakout.v1.Registration
 */
export class Registration extends Message<Registration> {
  ...
  /**
   * @generated from field: wgtwo.sipbreakout.v1.RouteType route_type = 4;
   */
   ...
   *
   * @generated from field: wgtwo.common.v1.E164 phone_number = 5;
   */
  phoneNumber?: E164;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "wgtwo.sipbreakout.v1.Registration";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 5, name: "phone_number", kind: "message", T: E164 },
  ]);
